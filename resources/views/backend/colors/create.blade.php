...
<div class="col-sm-12">
    <div class="iq-card">
        ...
        <div class="iq-card-body">
            <form action="{{route('colors.store')}}" id="color_store" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                <div class="form-row">
...
@push('script')
{!! JsValidator::formRequest('App\Http\Requests\StoreColorRequest', '#color_store') !!}
@endpush
