            ...
            <div class="iq-card-body">
                <div id="table" class="table-editable">
                    <span class="table-add float-right mb-3 mr-2">
                        <a href="{{ route('sizes.create') }}" class="btn btn-sm iq-bg-success">
                            <i class="ri-add-fill">
                                <span class="pl-1">Create Size</span>
                            </i>
                        </a>
                    </span>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    <a class="dropdown-item" href="{{ route('sizes.edit', $item->id) }}"><i
    ...
    <script>
        function checkValue() {
            ...
            if (search.value.length == 0) {
                window.location.href = "{{ URL::to('sizes') }}"
            }
        }

        function updateHandler($id) {
            window.location.href = `{{ URL::to('sizes/${$id}/edit') }}`;
        }
