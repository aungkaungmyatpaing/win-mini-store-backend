...
<div class="col-sm-12">
    <div class="iq-card">
            ...
            <div id="table" class="table-editable">
                ...
                <a href="{{ route('payment-accounts.create') }}" class="btn btn-sm iq-bg-success">
                    <i class="ri-add-fill">
                        <span class="pl-1">Create Account</span>
                    </i>
                </a>
                </span>
                            ...
                            <tr>
                                ...
                                <td align="center" >
                                    @if ($item->payment)
                                        <div class="rounded" style="width: 50px; height: 50px; overflow:hidden;">
                                            ...
                                            src="{{ asset('storage/images/' . $item->payment->payment_logo) }}"
                                            alt="{{ $item->payment->name }}">
                                        </div>
                                    @else
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <a class="dropdown-item" href="{{route('payment-accounts.edit', $item->id)}}"><i class="ri-pencil-line"></i> Edit</a>
        ...
        $(document).on('click', '.delete_btn', function(e) {
            ...
            if (willDelete) {
                ...
                headers: {
                    ...
                    window.location.href = "{{URL::to('payment-accounts')}}"
                })
            }
            });
        })
