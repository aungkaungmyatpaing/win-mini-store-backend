                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a class="dropdown-item" href="{{route('brands.edit', $item->id)}}"><i class="ri-pencil-line"></i> Edit</a>
    ...
    <script>
        function checkValue() {
            ...
            if(search.value.length == 0) {
                window.location.href = "{{URL::to('brands')}}"
            }
        }

        function updateHandler($id) {
            window.location.href = `{{URL::to('brands/${$id}/edit')}}`;
        }
