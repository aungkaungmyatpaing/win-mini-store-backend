        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Deliver List - {{$totalCount}}</h4>
                </div>
            </div>
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    <a class="dropdown-item"
                                                        ...
                                                        <button class="dropdown-item complete_btn" data-id={{ $item->id }}><i class="ri-check-line"></i>Complete</button>
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            window.location.href = "{{ URL::to('orders/deliver') }}"
                        })
                    }
                });
        })
