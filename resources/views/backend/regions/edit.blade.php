...
<div class="col-sm-12">
    <div class="iq-card">
        ...
        <div class="iq-card-body">
            <form action="{{route('regions.update',$region->id)}}" id="region_store" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                @method('put')
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" name="name" value="{{ $region->name }}" required>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom02" name="name_mm" value="{{ $region->name_mm }}" required>
                        <div class="valid-feedback">
                        Looks good!
                        </div>
                    </div>
