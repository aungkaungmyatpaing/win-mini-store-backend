...
<div class="col-sm-12">
    <div class="iq-card">
            ...
            <div id="table" class="table-editable">
                ...
                <a href="{{ route('regions.create') }}" class="btn btn-sm iq-bg-success">
                    <i class="ri-add-fill">
                        <span class="pl-1">Create Region</span>
                    </i>
                </a>
                </span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <a class="dropdown-item" href="{{route('regions.edit', $item->id)}}"><i class="ri-pencil-line"></i> Edit</a>
    ...
    <script>
        function checkValue() {
            ...
            if(search.value.length == 0) {
                window.location.href = "{{URL::to('regions')}}"
            }
        }

        function updateHandler($id) {
            window.location.href = `{{URL::to('regions/${$id}/edit')}}`;
        }
